		...
		<table>
				...
				<thead>
	 			...
	 			<tbody>
	 				...
	 				<th>
	 					Eddard Stark <br/>
							<img class="img_bio" src="./Ned.png" alt="Eddard_Stark" >
					</th>
	 				<td>
					...
					<tr>
	 					<td>
	 						Jon Snow <br/>
	 						<img class="img_bio" src="./Jon.pnj.png" alt="Jon_Snow" >
	 					</td>
	 					<td>
	 				...
	 				<tr>
						<td>
							Arya Stark <br/>
							<img class="img_bio" src="./Arya.png" alt="Arya_Stark" >
						</td>
						<td>
	 				...
	 				<tr>
						<td>
							Sansa Stark <br/>
							<img class="img_bio" src="./Sansa.png" alt="Sansa_Stark" >
						</td>
						<td>
					...
					<tr>
						<td>
							Catelyn Stark <br/>
							<img class="img_bio" src="./Catelyn.png" alt="Cately_Stark" >
						</td>
						<td>
					...
					<tr>
						<td>
							Robb Stark<br/>
							<img class="img_bio" src="./Robb.png" alt="">
						</td>		
						<td>
				 ...
				 il remporte toutes ses batailles face aux Lannister. Pour s'assurer une alliance avec le sire des Jumeaux, qui tient le passage entre
				  ...
				  surnommé les noces pourpres. C'est l'acteur Richard Madden qui a été choisi pour incarner Robb Stark dans la série télévisée adaptée des romans,
				   Le Trône de fer10. Il a 17 ans au lieu de 14 au début de la série.
						...
						<th>
						Bran Stark<br/>
						<img class="img_bio"src="./Bran.png" alt="">					
						</th>		
	 				<td>
